#
#  Be sure to run `pod spec lint eigen.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https://github.com/SkyroadJP/bezier"
  ...
  spec.source       = { :git => "https://github.com/SkyroadJP/bezier.git", :tag => "#{spec.version}" }
  ...
  spec.preserve_paths = "include/*", "include/**/*"
